...
MONGO_DATABASE=comicsdb
MONGO_PORT=27017
MONGO_URI=mongodb://admin:admin123@mongodb:27017/comicsdb?authSource=admin
...
- Los datos de MongoDB se persisten en un volumen de Docker llamado `mongodb_data`
- La carpeta `tmp/` es creada por Air y está en `.gitignore`
- El archivo `.env` está incluido para facilitar el desarrollo, pero en producción deberías usar `.env.production` y no commitear credenciales reales